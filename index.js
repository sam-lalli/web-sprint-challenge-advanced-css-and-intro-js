...
console.log(changeName(artists, 8, "Vinvent Van Gogh"));
...
function getArtistByIndex(array, index) {
    let findArtist = array[index]
    return `The artist at index ${findArtist.id} is ${findArtist.name}`
  }
